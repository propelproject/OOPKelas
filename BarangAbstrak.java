...
/**
 * Write a description of class BarangAbstrak here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class BarangAbstrak extends Inventory
{
    // instance variables - replace the example below with your own

    /**
     * Constructor for objects of class BarangAbstrak
     */
    public BarangAbstrak(String namaInventory, String namaUkuran, String namaSatuan, float satuan, float harga, int stok)
    {
